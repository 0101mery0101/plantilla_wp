                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn header-item waves-effect"
                                ...
                                <img class="rounded-circle header-profile-user" src="plantilla/Admin/vertical/assets/images/users/avatar-2.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-sm-inline-block ml-1">Mery Store.</span>
                                <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="preguntasprecuentes.php" class="waves-effect"><i class="mdi mdi-home-analytics"></i><span
                                        class="badge badge-pill badge-primary float-right">7</span><span>preguntas precuentes</span></a>
                            </li>
                            <li>
                                <a href="cuestionario.php" class="waves-effect"><i class="mdi mdi-home-analytics"></i><span
                                        class="badge badge-pill badge-primary float-right">7</span><span>cuestionario</span></a>
                            </li>
                            ...
                            <li>
                                <a href="producto.html" class="has-arrow waves-effect"><i
                                    class="mdi mdi-diamond-stone"></i><span>Tienda fisica</span></a>
                            </li>

                            <li>
                                <a href="producto.html" class="has-arrow waves-effect"><i
                                    class="mdi mdi-diamond-stone"></i><span>Ventas</span></a>
                            </li>

                            <li>
                                <a href="producto.html" class="has-arrow waves-effect"><i
                                    class="mdi mdi-diamond-stone"></i><span>Pedidos</span></a>
                            </li>

                            <li>
                                <a href="producto.html" class="has-arrow waves-effect"><i
                                    class="mdi mdi-diamond-stone"></i><span>Caatalogo</span></a>
                            </li>

                            <li class="menu-title">Salir</li>
